...
static void all_screens(void){
    ...
    expect(&m,MBR_SCREEN_HOME_SEARCHING_HELP,G("HOME SEARCHING HELP","UNLESS IT IS CANCELED","THE SEARCH WILL TAKE","A FEW SECONDS AND","WILL BE TRIGGERED","EVERY TIME YOU ACCESS","THIS SCREEN.","","ANY KEY: BACK"));
    ...
    m.selection=0; expect(&m,MBR_SCREEN_HOME_CONNECTED,G("MOUSE CONNECTED","LOGITECH LIFT"," REMAPPED TO STANDARD"," SAVED DEVICES"," LEARN THE KEYS","","JOY UP / DOWN: SELECT","JOY PRESS: ACCESS","KEY X: HELP TO REMOVE"));
